...
// product prop 기준으로 상품 정보가 잘 렌더링 되는지
// onClickCartButton, onClickPurchaseButton 함수가 올바르게 호출되는지 -> 스파이 함수

// 스파이 함수 호출 여부만 검증 -> 사용자가 productCard 눌렀을 때의 동작을 검증 불가
// API에서 주는 데이터 기준으로 올바르게 랜더링되는지도 검증 불가
const ProductCard = ({
  product,
